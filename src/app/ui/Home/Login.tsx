        ...
        <div className="h-fit relative container-transparent">
          <div>
            <Image
              ...
              onClick={() => router.push('/')}
            />
            <h2 className="mt-16 text-center text-3xl font-bold leading-9 tracking-tight text-white">{auth.user ? auth.user.name : 'Stock Wise Works'}</h2>
          ...
          <div className="mt-10 w-[70vh]">
            {auth.user ? (
              ...
              <form className="space-y-5 px-10" onSubmit={(e) => submitHandler(e)}>
                ...
                <p className="text-sm text-primary hover:text-white">¿contraseña olvidada?</p>
